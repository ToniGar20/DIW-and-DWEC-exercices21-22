...
With Sass, you can use features that don't exist in classical CSS like: variables, nesting, mixings, etc.
Learning SASS: [Guide]("https://sass-lang.com/guide")
...
To compile any SCSS file, first of all installation:

    npm install -g sass

To compile (from "/scss" directory) ,

    sass scss/styles.scss css/styles.css

To compile with each change:
